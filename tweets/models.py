...
from tweets.constants import TweetPhotoStatus, TWEET_PHOTO_STATUS_CHOICE
...
class Tweet(models.Model):
    ...
    # 回文索引
    class Meta:
        # the , must be added at the end of the tuple
        # to represent this is a list of tuples
        index_together = (('user', 'created_at'),)
        ordering = ('user', '-created_at')

    @property
    def hours_to_now(self):
        # how many hours has the tweet been created
...
class TweetPhoto(models.Model):
    ...
    status = models.IntegerField(
        ...
        choices=TWEET_PHOTO_STATUS_CHOICE,
    )
